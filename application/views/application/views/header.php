          ...
          <article id="contenido_l">
    		...
    		<div id="menu">
				...
				?>
	    			...
	    			-->
        			<span class="nav_comp <?php if($sitio == "queesfitit") echo "marcado"; ?>"><a href="/fitit_v2/queesfitit"><span class="texto_login ms" style="font-weight: bold;">¿QUÉ ES FITIT?</span></a></span>
              <span class="nav_comp <?php if($sitio == "index") echo "marcado"; ?>"><a href="/fitit_v2/#coatchs"><span class="texto_login ms" style="font-weight: bold;">ELIGE A TU COACH</span></a></span>
              <span class="nav_comp <?php if($sitio == "erescoach") echo "marcado"; ?>"><a href="/fitit_v2/erescoach"><span class="texto_login ms" style="font-weight: bold;">¿ERES COACH FITNESS?</span></a></span>
