					...
					foreach ($coatchs as $coatch)
					{
						...
						?>
							...
							<div class="influencer">
								...
								<div class="nombre"><a href="<?=$coatch->instagram?>"><?=$coatch->instagram?></div>
				...
				<a href="/fitit_v2/inicio/influencer/<?=$coatch->id_coatch?>">
					<div class="influencer">
						...
						<?php 
							...
							{
								?>
									<div class="nombre"><a href="https://www.instagram.com/<?=$coatch->instagram?>" style="font-size: 15px; color: #541b8a; cursor: pointer;" >@<?=$coatch->instagram?></a></div>
								<?php
							}
						?>
